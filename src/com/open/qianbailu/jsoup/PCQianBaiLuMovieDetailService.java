	...
	public static MovieDetailJson parsePicture(String href) {
		...
		try {
			...
			try {
				...
				if(divElement!=null){
					String imgrsc = UrlUtils.QIAN_BAI_LU_HTTP+divElement.select("img").first().attr("src");
					mMovieDetailJson.setMovieDetaiImg(imgrsc);
					mMovieDetailJson.setSec_info_intro( divElement.select("img").first().attr("alt"));
					
					/**
					 *  <li><span>影片类型：</span><a target="_blank" href="/list/6.html" title="乱伦虐待">乱伦虐待</a></li>
        <li><span>看片帮助：</span><a target="_blank" href="/detail/help.html" rel="nofollow">看片教程</a></li>
        <li><span>移动端看片：</span><a target="_blank" href="、detail/mobile.html" rel="nofollow">看片教程</a></li>
        <li><div class="fl"><span>更新日期：</span>2016-12-10</div><a class="fr" href="#pl" style="text-align:right; margin-right:10px;"><img src="//ww4.sinaimg.cn/large/005Z6lBIjw1eod4d93jasg302i00m3y9.gif" alt="查看评论" width="90" height="22" /></a></li>
        <li><span>最新网址：</span>WWW.1111AV.CO</li>
					 */
					try {
        ...
        <ul>
          <li>
            <p>最新加勒比 120716-319 性欲処理マゾマスク ～欲して闷える濡れた美熟女</p>
<span>
<a class="d1" href="thunder://QUFlZDJrOi8vfGZpbGV8RjY0RjZERUU4NUJCN0Y2REM0NkZGRUQ2MzBCNTY0NjgubXA0fDE5MDA3NDcwODB8RjY0RjZERUU4NUJCN0Y2REM0NkZGRUQ2MzBCNTY0Njh8aD1LWkM1RE1SUUJOR1dPTTVDVUNOSkI0R0U2VTJVQ0lRVXwvWlo=" target="_blank">迅雷下载</a>
<a class="d2" href="qqdl://ZWQyazovL3xmaWxlfGNhcmliLTEyMDcxNi0zMTkubXA0fDE5MDA3NDcwODB8RjY0RjZERUU4NUJCN0Y2REM0NkZGRUQ2MzBCNTY0Njh8aD1LWkM1RE1SUUJOR1dPTTVDVUNOSkI0R0U2VTJVQ0lRVXwv" target="_blank">旋风下载</a>
<a class="d3" href="flashget://W0ZMQVNIR0VUXWVkMms6Ly98ZmlsZXxjYXJpYi0xMjA3MTYtMzE5Lm1wNHwxOTAwNzQ3MDgwfEY2NEY2REVFODVCQjdGNkRDNDZGRkVENjMwQjU2NDY4fGg9S1pDNURNUlFCTkdXT001Q1VDTkpCNEdFNlUyVUNJUVV8L1tGTEFTSEdFVF0=" target="_blank">快车下载</a>
<a class="d4" href="ed2k://|file|carib-120716-319.mp4|1900747080|F64F6DEE85BB7F6DC46FFED630B56468|h=KZC5DMRQBNGWOM5CUCNJB4GE6U2UCIQU|/" target="_blank">电驴下载</a></span> 
           </li>
        </ul>
      </div>
							...
							try {
								...
								if (aElement != null) {
									try {
										...
										src = src.replace("http://i1.1100lu.xyz", "http://mi1.100av.org/m");
