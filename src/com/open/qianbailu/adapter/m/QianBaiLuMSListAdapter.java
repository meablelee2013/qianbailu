 ...
 ***************************************************************************************************************************************************************************** 
 */
public class QianBaiLuMSListAdapter extends CommonAdapter<MovieBean> {

	public QianBaiLuMSListAdapter(Context mContext, List<MovieBean> list) {
		super(mContext, list);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.adapter_qianbailu_m_s_list, parent, false);
