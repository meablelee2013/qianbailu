...
public class UrlUtils {
   /** 浏览器代理 **/
	...
	/***m地址**/ 
	public static final String QIAN_BAI_LU_M = "https://m.333lu.vip/";
	/***电影首页**/
	public static final String QIAN_BAI_LU_M_VLIST = "https://m.333lu.vip/vlist.php";
	/***电影分页**/
	public static final String QIAN_BAI_LU_M_VLIST_CLASSID = "https://m.333lu.vip/vlist.php?classid=1";
	/***图库**/
	public static final String QIAN_BAI_LU_M_VLIST_B = "https://m.333lu.vip/blist.php?bclassid=11";
	/***小说**/
	public static final String QIAN_BAI_LU_M_VLIST_S = "https://m.333lu.vip/blist.php?bclassid=1";
	/***图库详细**/
	public static final String QIAN_BAI_LU_M_VLIST_B_CLASSID   = "https://m.333lu.vip/list.php?page=2&classid=2&bclassid=1";
	/***图片地址**/
	public static final String QIAN_BAI_LU_HTTP = "http:";
	public static final String QIAN_BAI_LU_HTTPS = "https:";
	/***图库详细**/
	public static final String QIAN_BAI_LU_SHOW = "https://m.333lu.vip/show.php?id=388511&classid=13";
	/***小说详细**/
	public static final String QIAN_BAI_LU_XIAO_SHUO = "https://m.333lu.vip/show.php?id=393114&classid=2";
	/***电影详细**/
	public static final String QIAN_BAI_LU_MOVIE = "https://m.333lu.vip/vshow.php?id=11174";
	...
	/***搜索地址**/
	public static final String QIAN_BAI_LU_SEARCH = "https://m.333lu.vip/search.php";
	/***搜索例子**/
	...
	//网页
	/***HOST地址**/
	public static final String QIAN_BAI_LU_HOST = "333av.vip";
	/***pc地址**/
	public static final String QIAN_BAI_LU = "https://333av.vip";
	/***电影首页**/
	public static final String PC_QIAN_BAI_LU_VLIST = "https://333av.vip/vod/index.html";
	/***电影1**/
	public static final String PC_QIAN_BAI_LU_VLIST_CLASSID ="https://333av.vip/list/1.html";
	/***电影详细**/
	public static final String PC_QIAN_BAI_LU_MOVIE = "https://333av.vip/vod/11193.html";
	/***电影详细vod**/
	public static final String PC_QIAN_BAI_LU_VOD = "https://333av.vip/vod/11400.html#pl";
	/***图库**/
	public static final String PC_QIAN_BAI_LU_M_VLIST_B = "https://333av.vip/html/tupian/index.html";
	/***图库详细**/
	public static final String PC_QIAN_BAI_LU_M_VLIST_B_CLASSID   = "https://333av.vip/html/tupian/toupai/";
	/***看图图库详细**/
	public static final String PC_QIAN_BAI_LU_SHOW = "https://333av.vip/html/tupian/yazhou/2016/0923/388511.html";
	/***小说**/
	public static final String PC_QIAN_BAI_LU_VLIST_S = "https://333av.vip/html/article/index.html";
	/***小说列表**/
	public static final String PC_QIAN_BAI_LU_VLIST_J = "https://333av.vip/html/article/jiqing/index.html";
	/***小说详细**/
	public static final String PC_QIAN_BAI_LU_XIAO_SHUO = "https://333av.vip/html/article/jiqing/2017/0107/393310.html";
	/***电影在线**/
	public static final String PC_QIAN_BAI_LU_ONLINE ="https://333av.vip/list/14.html";
	/***pc搜索地址**/
	...
	/***网站公告**/
	public static final String PC_QIAN_BAI_LU_NOTICE = "https://333av.vip/detail/gg.html";
	/***热搜排行**/
	public static final String PC_QIAN_BAI_LU_HOT = "https://333av.vip/detail/hot.html";
	/***看片留言**/
	public static final String PC_QIAN_BAI_LU_GUEST_BOOK = "https://333av.vip/detail/guestbook.html";
	/***最近更新**/
	public static final String PC_QIAN_BAI_LU_NEW = "https://333av.vip/detail/new.html";
